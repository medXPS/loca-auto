...
export default function Home() {
  const { data: featuredCars, isLoading } = useListCars({
    limit: 3,
    sortBy: "popular" // Or any criteria for featured
  });
    ...
    <div className="flex flex-col w-full">
        ...
        <div className="container relative z-20 mx-auto px-4">
          <div className="max-w-2xl">
            ...
            <p className="text-lg md:text-xl text-foreground/80 mb-8 max-w-xl">
              Réservez facilement votre véhicule idéal pour explorer le Maroc. 
              Processus simple, prix transparents, payez à l'agence.
            </p>
              ...
              <form className="grid grid-cols-1 md:grid-cols-3 gap-4" onSubmit={(e) => { e.preventDefault(); }}>
                <div className="space-y-2">
                  ...
                  <div className="relative">
                    ...
                    <Input placeholder="Ex: Casablanca" className="pl-9" />
                  </div>
                </div>
                <div className="space-y-2">
                  <label className="text-sm font-medium ml-1">Date de location</label>
                  <div className="relative">
                ...
                <div className="flex items-end">
                  <Link href="/voitures" className="w-full">
                    <Button className="w-full h-10 gap-2 text-base">
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12 relative">
            ...
            <div className="text-center">
              ...
              <p className="text-muted-foreground">
                Parcourez notre catalogue et sélectionnez le véhicule qui correspond à vos besoins et à votre budget.
              </p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-muted-foreground">
                Remplissez le formulaire de réservation en ligne. Aucun paiement par carte n'est requis à cette étape.
              </p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-muted-foreground">
                Notre agent vous appelle pour confirmer. Passez ensuite à l'agence pour régler et récupérer votre voiture.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="py-20 bg-secondary text-secondary-foreground">
        <div className="container mx-auto px-4 text-center">
          <h2 className="text-3xl md:text-4xl font-serif font-bold mb-6">Prêt pour votre voyage au Maroc ?</h2>
          <p className="text-lg opacity-90 mb-10 max-w-2xl mx-auto">
            Contactez-nous dès aujourd'hui ou réservez directement en ligne pour profiter de nos meilleures offres de location de voitures.
          </p>
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            <Link href="/voitures">
              <Button size="lg" className="w-full sm:w-auto px-8 bg-primary hover:bg-primary/90 text-primary-foreground border-none">
                Réserver maintenant
              </Button>
            </Link>
            <Button size="lg" variant="outline" className="w-full sm:w-auto px-8 bg-transparent border-secondary-foreground/20 hover:bg-secondary-foreground/10 text-secondary-foreground">
              Contactez-nous
            </Button>
          </div>
        </div>
