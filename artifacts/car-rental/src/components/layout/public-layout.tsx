    ...
    <div className={cn("public-site min-h-screen overflow-x-hidden text-foreground", isHomePage ? "bg-[#f4f6fb]" : "bg-transparent")}>
      <header
        className={cn(
          ...
          isHomePage ? "border-white/10 bg-[#08111d]/94 text-white" : "border-border/60 bg-white/92",
        )}
      >
        <div className="container mx-auto flex h-[68px] items-center justify-between gap-4 px-4">
          <Link href="/" className="min-w-0">
            <SiteLogo tone={isHomePage ? "light" : "dark"} />
          </Link>
        ...
        {isMenuOpen && (
          <div className={cn("border-t lg:hidden", isHomePage ? "border-white/10 bg-[#08111d]" : "border-border/60 bg-white")}>
                  ...
                  return (
                    <Link
                      ...
                      className={cn(
                        ...
                        isHomePage
                          ? active
                            ? "border-[#ff4d43]/40 bg-white/8 text-white"
                            : "border-white/10 bg-white/4 text-white/86"
                          : active
                    ...
                    >
                      ...
                      <ArrowRight className={cn("h-4 w-4", isHomePage ? "text-white/48" : "text-muted-foreground")} />
                    </Link>
                  );
                })}
              </div>
      ...
      <footer
        className={cn(
          "border-t",
          isHomePage ? "mt-0 border-white/8 bg-[#08111d] text-white" : "mt-16 border-border/70 bg-white text-foreground",
        )}
      >
        {isHomePage ? (
          <>
      ...
      {!isCarDetailPage && (
        <div
          className={cn(
            ...
            isHomePage ? "border-white/10 bg-[#08111d]/96" : "border-border/70 bg-white/96",
          )}
        >
